...
export default function PendientesHistoricos() {
  ...
  // El panel tiene dos caras: la fila abre los datos del envio y el mensaje al cadete,
  // el icono de etiqueta abre solo etiquetas y conversacion.
  const [modo, setModo] = useState("detalle");
  const abrirPanel = (row, cual) => { setSelected(row); setModo(cual); setBorrador(""); };
